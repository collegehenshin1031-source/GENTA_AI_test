...
# UI設定・CSS
# ==========================================
# スマホで見やすいようにデフォルトでサイドバーは閉じた状態にしています
...
def render_sidebar():
    ...
    <h3 style='margin-top: 0; margin-bottom: 10px; font-size: 1.1rem; color: #C41E3A;'>🦅 記号の解説</h3>
    <ul style='padding-left: 20px; margin-bottom: 0; font-size: 0.9rem; line-height: 1.6; color: #333;'>
